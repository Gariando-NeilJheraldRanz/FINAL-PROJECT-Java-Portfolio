...
public class Main {
    public static void main(String[] args) {
        AirConditioner airConditioner1 = new AirConditioner("Aircon", 3, 24);
        LampShade lamp1 = new LampShade("Bedroom Lamp", 100, "Yellow");
        LampShade lamp2 = new LampShade(lamp1); // copy constructor
        Television television1 = new Television("LG TV", 1, 10);
        MicrowaveOven microwave1 = new MicrowaveOven("Microwave", 0, 0);

        List<Device> devices = Arrays.asList(airConditioner1, lamp1, lamp2, television1, microwave1);

        DeviceHelper.controlDevices(devices, true);  // Turn all devices on
        DeviceHelper.controlDevices(devices, false); // Turn all devices off
...
class DeviceHelper {
    public static void controlDevices(List<Device> devices, boolean powerOn) {
